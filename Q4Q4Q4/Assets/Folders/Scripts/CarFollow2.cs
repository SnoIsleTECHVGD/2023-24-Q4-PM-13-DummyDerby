...
public class CarFollow2 : MonoBehaviour
{
    ...
    private CarController controllerReference;
    [Range(0, 20)] public float smothTime = 5;
    public int locationIndicator = 2;

    private void Start()
    {
        atachedVehicle = GameObject.FindGameObjectWithTag("Player2");
        controllerReference = atachedVehicle.GetComponent<CarController>();
        cameraPositionFolder = atachedVehicle.transform.Find("CAMERA2").gameObject;
